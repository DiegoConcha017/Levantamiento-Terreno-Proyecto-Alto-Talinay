...
var format_Deslindesprediales_2 = new ol.format.GeoJSON();
var features_Deslindesprediales_2 = format_Deslindesprediales_2.readFeatures(json_Deslindesprediales_2, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Deslindesprediales_2 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Deslindesprediales_2.addFeatures(features_Deslindesprediales_2);
var lyr_Deslindesprediales_2 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Deslindesprediales_2, 
                style: style_Deslindesprediales_2,
                popuplayertitle: 'Deslindes prediales',
                interactive: false,
                title: '<img src="styles/legend/Deslindesprediales_2.png" /> Deslindes prediales'
            });
var format_Edificioproyectado_3 = new ol.format.GeoJSON();
var features_Edificioproyectado_3 = format_Edificioproyectado_3.readFeatures(json_Edificioproyectado_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Edificioproyectado_3 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Edificioproyectado_3.addFeatures(features_Edificioproyectado_3);
var lyr_Edificioproyectado_3 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Edificioproyectado_3, 
                style: style_Edificioproyectado_3,
                popuplayertitle: 'Edificio proyectado',
                interactive: false,
                title: '<img src="styles/legend/Edificioproyectado_3.png" /> Edificio proyectado'
            });
var format_calicata_4 = new ol.format.GeoJSON();
var features_calicata_4 = format_calicata_4.readFeatures(json_calicata_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_calicata_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_calicata_4.addFeatures(features_calicata_4);
var lyr_calicata_4 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_calicata_4, 
                style: style_calicata_4,
                popuplayertitle: 'calicata',
                interactive: true,
    title: 'calicata<br />\
    <img src="styles/legend/calicata_4_0.png" /> 2017<br />\
    <img src="styles/legend/calicata_4_1.png" /> 2025<br />\
    <img src="styles/legend/calicata_4_2.png" /> 2026<br />' });
var format_sondaje_5 = new ol.format.GeoJSON();
var features_sondaje_5 = format_sondaje_5.readFeatures(json_sondaje_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_sondaje_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_sondaje_5.addFeatures(features_sondaje_5);
var lyr_sondaje_5 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_sondaje_5, 
                style: style_sondaje_5,
                popuplayertitle: 'sondaje',
                interactive: true,
                title: '<img src="styles/legend/sondaje_5.png" /> sondaje'
            });
var format_remociones_masa_6 = new ol.format.GeoJSON();
var features_remociones_masa_6 = format_remociones_masa_6.readFeatures(json_remociones_masa_6, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_remociones_masa_6 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_remociones_masa_6.addFeatures(features_remociones_masa_6);
cluster_remociones_masa_6 = new ol.source.Cluster({
  distance: 30,
  source: jsonSource_remociones_masa_6
});
var lyr_remociones_masa_6 = new ol.layer.Vector({
                declutter: false,
                source:cluster_remociones_masa_6, 
                style: style_remociones_masa_6,
                popuplayertitle: 'remociones_masa',
                interactive: true,
                title: '<img src="styles/legend/remociones_masa_6.png" /> remociones_masa'
            });
var format_afloramientos_7 = new ol.format.GeoJSON();
var features_afloramientos_7 = format_afloramientos_7.readFeatures(json_afloramientos_7, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_afloramientos_7 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_afloramientos_7.addFeatures(features_afloramientos_7);
cluster_afloramientos_7 = new ol.source.Cluster({
  distance: 30,
  source: jsonSource_afloramientos_7
});
var lyr_afloramientos_7 = new ol.layer.Vector({
                declutter: false,
                source:cluster_afloramientos_7, 
                style: style_afloramientos_7,
                popuplayertitle: 'afloramientos',
                interactive: true,
                title: '<img src="styles/legend/afloramientos_7.png" /> afloramientos'
            });
var group_Terreno = new ol.layer.Group({
                                layers: [lyr_remociones_masa_6,lyr_afloramientos_7,],
                                fold: 'open',
                                title: 'Terreno'});
